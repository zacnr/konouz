                ...
                <div class="body">
                    <div class="gallery-box" id="gallerybox">
                        ...
                        <div class="gallery-image-edit" id="gallery-{{$gallery->id}}">
                            ...
                            <img class="img-responsive" src="{{asset('storage/property/gallery/'.$gallery->name)}}" alt="{{$gallery->name}}">
                        </div>
                        @endforeach
                    </div>
                ...
                <div class="body">
                    <div class="form-group">
                        @if(Storage::disk('public')->exists('property/'.$property->floor_plan) && $property->floor_plan )
                            <img src="{{asset('storage/property/'.$property->floor_plan)}}" alt="{{$property->title}}" class="img-responsive img-rounded"> <br>
                        @endif
                ...
                <div class="body">
                    ...
                    <div class="form-group">
                        @if(Storage::disk('public')->exists('property/'.$property->image))
                            <img src="{{asset('storage/property/'.$property->image)}}" alt="{{$property->title}}" class="img-responsive img-rounded"> <br>
                        @endif
