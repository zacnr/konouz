    ...
    <div class="row clearfix">
        ...
        <div class="col-lg-8 col-md-4 col-sm-12 col-xs-12">
            ...
            <div class="card">
                ...
                <div class="body">
                    <img class="img-responsive" src="{{asset('storage/property/'.$property->floor_plan)}}" alt="{{$property->title}}">
                </div>
                @endif
            </div>
            @endif
                ...
                <div class="body">
                    <div class="gallery-box">
                        ...
                        <div class="gallery-image">
                            <img class="img-responsive" src="{{asset('storage/property/gallery/'.$gallery->name)}}" alt="{{$property->title}}">
                        </div>
                        @endforeach
                    </div>
                </div>
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            ...
            <div class="card">
                ...
                <div class="body">
                    ...
                    <img class="img-responsive thumbnail" src="{{asset('storage/property/'.$property->image)}}" alt="{{$property->title}}">
