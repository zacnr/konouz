<footer class="page-footer indigo darken-2">
    <div class="container">
        <div class="row">
            <div class="col m4 s12">
                <h5 class="white-text uppercase">À propos de nous</h5>
            ...
            <div class="col m6 s12">
                ...
                <ul class="collection border0">
                    ...
                    <li class="collection-item transparent clearfix p-0 border0">
                        <span class="card-image-bg m-r-10" style="background-image:url({{asset('storage/property/'.$property->image)}});width:60px;height:45px;float:left;"></span>
            ...
            <div class="col m2 s12">
                ...
                <ul>
                    ...
                    <li class="uppercase {{ Request::is('gallery*') ? 'underline' : '' }}">
                        <a href="{{ route('gallery') }}" class="grey-text text-lighten-3">Galerie</a>
                    </li>
    ...
    <div class="footer-copyright">
        <div class="container">
            ...
            @else
                © 2020 Projet de fin d'année ENSA AGADIR.
            @endif
