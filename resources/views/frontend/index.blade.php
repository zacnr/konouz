                        ...
                        <div class="card">
                            <div class="card-image">
                                @if(Storage::disk('public')->exists('property/'.$property->image) && $property->image)
                                    <span class="card-image-bg" style="background-image:url({{asset('storage/property/'.$property->image)}});"></span>
                                @else
                    ...
                    <div class="card">
                        <div class="card-image">
                            @if(Storage::disk('public')->exists('posts/'.$post->image) && $post->image)
                                <span class="card-image-bg" style="background-image:url({{asset('storage/posts/'.$post->image)}});"></span>
                            @endif
                        </div>
                        <div class="card-content">
